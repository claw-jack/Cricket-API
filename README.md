...
- `GET /live` — live/recent/upcoming Cricbuzz match list with details for the first few matches
  - `?details=0` skips detail-page fetches
  - `?limit=3` controls how many match detail pages are visited
